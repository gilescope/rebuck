    ...
    // driver's two failure horizons — make both visible in the job log.
    {
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                println!(
                    "[stats] store={:.2} GiB served_total={:.2} GiB serve_rate={:.1} MiB/s pending_jobs={} workers={} ac_ok={} ac_fail={} dnc_exec={} sf_merged={} queued[{}] grpc[ac {}/{}/{}u {:.2} GiB | casR {} {:.2} GiB | casW {:.2} GiB]",
